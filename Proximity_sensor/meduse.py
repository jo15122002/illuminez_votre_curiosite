...
led1 = LedStrip(13, 21, 0, 0)
led2 = LedStrip(33, 44, 0, 0)
led3 = LedStrip(16, 21, 0, 0)

leds = [led1, led2, led3]

# for led in leds:
#     led.set_strip_color((0, 0, 255))
#     led.show()


sensor = ProximitySensor(26, 27, [led1, led2, led3])

for led in sensor.leds:
    led.stripColor = (200, 50, 200)
    # led.set_strip_color(((255, 0, 255)))
    # led.show()
